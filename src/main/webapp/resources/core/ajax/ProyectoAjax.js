 ...
 * }); }
 * 
 * function doAjaxEdit(id) { if (id == undefined) { $.ajax({ type : "POST", url :
 * "criteriosAjax", success : function(module) { refreshTable(module);
 * $("#showAtributos").hide(); }, error : function(e) { console.log('Error: ' +
 * e); } }); } else { $.ajax({ type : "POST", url : "criterios/edit/" + id,
 * success : function(tablas) { console.log(tablas); doAjaxGetTablas(tablas);
 * $("#showAtributos").show(); }, error : function(e) { console.log('Error: ' +
 * e); } }); } }
 * 
 ...
 * }); }
 * 
 * function doAjaxDelete(id) { $.ajax({ type : "DELETE", url :
 * "criterios/delete/" + id, success : function(module) { console.log(module);
 * refreshTable(module); }, error : function(e) { console.log('Error: ' + e); }
 * }); }
 */
