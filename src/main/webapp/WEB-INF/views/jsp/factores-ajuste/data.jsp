    ...
    <table width="100%" class="table table-condensed table-striped table-bordered tableForm">
        ...
        <tbody>
            <tr>
                ...
                <td class="col-xs-1">
                    <select id="solucion_definido" onchange="calculate2('solucion')" class="form-control">
                        <option selected value="0">No</option>
                        <option value="1">Sí</option>
                    </select>
                </td>
                <td class="col-xs-1">
                    <select id="solucion_conocimiento" onchange="calculate2('solucion')" class="form-control">
                        <option value="0">Ninguno</option>
                        <option value="1">Bajo</option>
            ...
            <tr>
                ...
                <td>
                    <select id="integracion_definido" onchange="calculate2('integracion')" class="form-control">
                        <option selected value="0">No</option>
                        <option value="1">Sí</option>
                    </select>
                </td>
                <td>
                    <select id="integracion_conocimiento" onchange="calculate2('integracion')" class="form-control">
                        <option value="0">Ninguno</option>
                        <option value="1">Bajo</option>
                        <option value="1">Medio</option>
                        <option value="1">Alto</option>
            ...
            <tr>
                ...
                <td>
                    <select id="logica_definido" onchange="calculate2('logica')" class="form-control">
                        <option selected value="0">No</option>
                        <option value="1">Sí</option>
                    </select>
                </td>
                <td>
                    <select id="logica_conocimiento" onchange="calculate2('logica')" class="form-control">
                        <option value="0">Ninguno</option>
                        <option value="1">Bajo</option>
                        <option value="1">Medio</option>
                        <option value="1">Alto</option>
            ...
            <tr>
                ...
                <td>
                    <select id="despliegue_definido" onchange="calculate2('despliegue')" class="form-control">
                        <option selected value="0">No</option>
                        <option value="1">Sí</option>
                    </select>
                </td>
                <td>
                    <select id="despliegue_conocimiento" onchange="calculate2('despliegue')" class="form-control">
                        <option value="0">Ninguno</option>
                        <option value="1">Bajo</option>
                        <option value="1">Medio</option>
                        <option value="1">Alto</option>
